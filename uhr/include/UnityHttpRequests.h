...
#define UHR_ERR_INVALID_URL 4
#define UHR_ERR_FAILED_TO_CREATE_REQUEST 5
#define UHR_ERR_UNKNOWN_ERROR_CODE 6
#define UHR_ERR_FAILED_TO_CREATE_SESSION 7
#define UHR_ERR_FAILED_TO_UPDATE_SESSION 8
